...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© :current_year tüm hakları saklıdır. | <a href=":dev_website" target="_blank" class="text-blue-600 hover:underline">:dev_name</a> tarafından geliştirilmiştir.',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'compare'       => 'Karşılaştır',
                        'dropdown-text' => 'Profil, Siparişler ve İstek Listesini Yönet',
                        'logout'        => 'Çıkış yap',
                        'orders'        => 'Siparişler',
                        'profile'       => 'Profil',
                        'search'        => 'Ara',
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2019 - :current_year, <a href=":dev_website" target="_blank" class="hover:underline">:dev_name</a>. Tüm hakları saklıdır.',
                'locale'                 => 'Yerel Ayar',
                'newsletter-text'        => 'Bültenimize Abone Olun!',
                ...
                'subscribe-stay-touch'   => 'Tüm gelişmelerden anında haberdar olmak için e-bültenimize abone olun.',
