...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© :current_year all rights reserved. | Developed by <a href=":dev_website" target="_blank" class="text-blue-600 hover:underline">:dev_name</a>.',
    ...
    'components' => [
        ...
        'layouts' => [
            'header' => [
                'desktop' => [
                    ...
                    'bottom' => [
                        ...
                        'compare'       => 'Compare',
                        'dropdown-text' => 'Manage Profile, Orders & Wishlist',
                        'logout'        => 'Logout',
                        'orders'        => 'Orders',
                        'profile'       => 'Profile',
                        'search'        => 'Search',
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2019 - :current_year, <a href=":dev_website" target="_blank" class="hover:underline">:dev_name</a>. All rights reserved.',
                'locale'                 => 'Locale',
                ...
                'subscribe-stay-touch'   => 'Subscribe to our e-newsletter to stay up to date on all the latest developments.',
