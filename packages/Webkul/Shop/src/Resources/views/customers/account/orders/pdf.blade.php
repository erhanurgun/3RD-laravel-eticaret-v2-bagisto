...
>
    ...
    <body dir="{{ core()->getCurrentLocale()->direction }}">
        <div class="logo-container {{ core()->getCurrentLocale()->direction }}">
            ...
            @elseif (file_exists(public_path('upload/logo/light.svg')))
                <img src="data:image/svg+xml;base64,{{ base64_encode(file_get_contents(public_path('upload/logo/light.svg'))) }}"/>
            @endif
        </div>
